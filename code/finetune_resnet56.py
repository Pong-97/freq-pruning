...
parser.add_argument('--refine', default="/home2/pengyifan/pyf/freq-lite/logs/resnet56/0.47/1/model_best54.pth.tar", type=str, metavar='PATH',
...
parser.add_argument('--save', default='/home2/pengyifan/pyf/freq-lite/logs/resnet56/0.47/finetuned/p47' , type=str, metavar='PATH',
...
if args.refine:
    ...
    # compress_rate = checkpoint['compress_rate'] 
    cfg = checkpoint['cfg']
    # pdb.set_trace()
    ...
    model = resnet_56(compress_rate=compress_rate)
